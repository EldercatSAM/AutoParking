...
class HeroTank(pygame.sprite.Sprite):
    ...
    def save_graph(self):
        import cv2
        img = cv2.imread(r"C:\Users\Sam\Documents\School\BJUT\Classes\智能控制\倒车入库\background_640x480.jpg")
        print(img.shape)
        for y,x in self.tank_route:
            img = cv2.circle(img, (x,y), 1, (0,0,255), -1 )
        
        cv2.imwrite(r"C:\Users\Sam\Documents\School\BJUT\Classes\智能控制\倒车入库\res.jpg", img)
